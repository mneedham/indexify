...
mod tests {
    ...
    use crate::metadata_storage::{MetadataReaderTS, MetadataStorageTS};
    use crate::server::NamespaceEndpointState;
    use crate::server_config::ServerConfig;
    use crate::vector_index::VectorIndexManager;
    use crate::vectordbs;
    use crate::coordinator_client::CoordinatorClient;
    use crate::blob_storage::ContentReader;
    use std::sync::Arc;
    ...
    async fn test_begin() {
        ...
        assert_eq!(new_payload.output_to_index_table_mapping, payload.output_to_index_table_mapping);
